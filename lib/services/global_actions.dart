      ...
      return SimpleDialog(
        ...
        children: [
          SimpleDialogOption(
            ...
            child: Text("Refresh Apps", style: TextStyle(color: textColor)),
          ),
          SimpleDialogOption(
            onPressed: () =>
                Navigator.pop(context, GlobalAction.exportGridJson),
            child: Text("Export Grid JSON", style: TextStyle(color: textColor)),
          ),
          SimpleDialogOption(
            onPressed: () =>
                Navigator.pop(context, GlobalAction.importGridJson),
            child: Text("Import Grid JSON", style: TextStyle(color: textColor)),
          ),
          SimpleDialogOption(
            onPressed: () => Navigator.pop(context, GlobalAction.changeTheme),
            child: Text("Change Theme", style: TextStyle(color: textColor)),
          ),
        ],
      );
    },
